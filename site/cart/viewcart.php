    ...
    <div class="bottom-nav">
      <div class="bottom-nav--title width-normal">
        ...
        <a? href="produt-by-category.html">Giỏ hàng</a>
      </div>
    </div>
        ...
        <form action="" class="form-list-cart" method="post" enctype="multipart/form-data">
            <div class="list-cart">
                <div class="list-cart--img">
                    <a href="#"><img src="../../content/images/product/beyono-golden-start-c-7.jpg" alt=""></a>
                </div>
                <div class="list-cart--name">
                    <a href="#">Giày Bóng Chuyền Beyono Sky Dream - White Red - 37</a>
                    <a href="#" class="list-cart--delete">Xóa</a>
                </div>
...
<html lang="en">
  <head>
    ...
    <title>Giày bóng chuyền chính hãng</title>
  </head>
  <body>
    <header class="header">
...
>>>>>>> 3c9431c8b38a6caa04825028f794c1fae1bb9d26
                </div>
                <div class="list-cart--quantity">
                    <div class="quantity buttons_added" style="margin-top: 0px">
                        <input type="button" value="-" class="minus minus2" /><input
...
>>>>>>>> 3c9431c8b38a6caa04825028f794c1fae1bb9d26:site/cart/cart-list.html
=======
            </div>
